...
| | |
| :--- | :--- |
| *Official URL*:http://ingvarso.github.io/fhir/ig/mal/StructureDefinition/mal-patient | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ingvarso.github.io.hackathon-2025-11-10|current/StructureDefinition/mal-patient)
...
```json
{
  ...
  "id" : "mal-patient",
  "url" : "http://ingvarso.github.io/fhir/ig/mal/StructureDefinition/mal-patient",
  "version" : "0.1.0",
  "name" : "MalPatient",
  "title" : "Pasient",
  "status" : "draft",
